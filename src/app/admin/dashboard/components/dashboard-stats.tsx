...
export default function DashboardStats({ stats }: DashboardStatsProps) {
  ...
  const cardData = [
    ...
    {
      title: "Incompletos",
      value: stats.incompleteAnalysis,
      description: `${stats.totalAnalysis > 0 ? Math.round((stats.incompleteAnalysis / stats.totalAnalysis) * 100) : 0}% del total`,
      icon: Clock,
      color: "text-orange-600",
      bgColor: "bg-orange-50",
      hoverColor: "hover:bg-orange-100",
      borderColor: "border-orange-200",
      filter: "incomplete" as FilterType,
    },
    {
