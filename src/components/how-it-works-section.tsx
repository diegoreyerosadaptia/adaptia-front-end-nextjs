...
export function HowItWorksSection({ onOpenDrawer }: HowItWorksSectionProps) {
  const steps = [
    {
      number: "1",
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-adaptia-blue-primary mb-6 text-balance">
            ¿Cómo funciona Adaptia?
          </h2>
        </div>
            ...
            >
              <CardContent className="p-8 text-center">
                <div className="flex items-center justify-center w-20 h-20 bg-gradient-to-br from-adaptia-blue-primary/10 to-adaptia-green-primary/10 rounded-2xl mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <div className="text-adaptia-blue-primary group-hover:text-adaptia-green-primary transition-colors duration-300">
                    {step.icon}
                  </div>
                </div>
                ...
                <h3 className="text-xl font-heading font-semibold text-adaptia-blue-primary mb-4 text-balance group-hover:text-adaptia-green-primary transition-colors duration-300">
                  {step.title}
                </h3>
                <p className="text-adaptia-blue-primary/70 text-pretty leading-relaxed font-heading">
                  {step.description}
                </p>
        ...
        <div className="text-center">
          <p className="text-2xl font-heading font-semibold text-adaptia-blue-primary mb-8">
            Así de fácil.
          </p>
          ...
          <Button
            ...
            className="btn-primary-brand transition-all duration-300"
          >
            Comenzar ahora
          </Button>
        </div>
